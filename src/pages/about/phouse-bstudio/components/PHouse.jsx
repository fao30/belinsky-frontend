    ...
    <>
      <div className="flex flex-wrap-reverse justify-around w-full h-full text-[#022581] group my-[8vh] md:my-[16vh]">
        <div className="max-md:px-[4vw] px-8 flex  w-[100%] md:w-[90%] lg:-[70%] xl:w-[50%] h-full items-center gap-5">
          <div className="flex flex-col w-[50%] items-start gap-5 z-10">
            <CardHeroPH
              src={ph1}
            ...
            <CardHeroPH
              src={ph2}
              className="w-[90%] object-cover transition duration-700 ease-in-out rounded-2xl grayscale hover:grayscale-0 translate-x-14 -translate-y-20 md:translate-x-14 md:-translate-y-40 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:duration-700 group-hover:ease-in-out group-hover:delay-75"
