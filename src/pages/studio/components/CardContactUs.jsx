...
const CardContactUs = () => {
  ...
  return (
    <div className="flex justify-center px-[6vw]">
      <div className="rounded-xl my-20 w-full md:w-[70%] lg:w-[90%] px-12 lg:px-20 lg:py-16 py-12 bg-[#022581] text-white">
        <div className="flex items-center justify-between gap-6">
          <div className="w-full lg:w-[60%] xl:w-[70%] flex flex-col">
