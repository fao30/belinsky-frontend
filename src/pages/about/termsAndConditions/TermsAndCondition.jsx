...
text-[#022581] px-[5vw]"
 ...
 text-[#022581] px-[5vw]"
      ...
      <h2 className="md:text-[32px] text-[13px] font-extrabold text-[#022581] text-start px-[4vw] py-[2vw]">
        B. Penggunaan Studio{" "}
      </h2>
      <ol className="list-decimal">
        <li
      ...
      {/* penggunaan studio ke 3 */}
      <h2 className="md:text-[32px] text-[13px] font-extrabold text-[#022581] text-start px-[4vw] py-[4vw]">
        B. Penggunaan Studio{" "}
      </h2>
      <ol className="list-decimal">
        <li
