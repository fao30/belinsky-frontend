  ...
  return (
    <>
      ...
      <form className="h-fit w-[90%] p-[0.5rem] md:w-[85%] xl:w-[70rem] bg-white mx-auto -mt-16 drop-shadow-[0_1.5px_1.5px_black]">
        <div className="flex flex-col md:flex-row xl:px-[7rem] px-[1.5rem] justify-center w-full h-full text-[#022581] xl:text-2xl font-semibold gap-10 p-5">
          <InputForm
            label="Name"
            type="text"
            name="name"
        ...
        <div className="flex flex-col md:flex-row px-[1.5rem] xl:px-[7rem] justify-center w-full h-full text-[#022581] xl:text-2xl font-semibold gap-10 p-5">
          <InputForm
            label="Email"
            type="email"
            name="email"
        ...
        <div className="flex flex-col p-5 md:flex-row px-[1.5rem] xl:px-[7rem] justify-start w-full h-full text-[#022581] xl:text-2xl font-semibold gap-4">
