  ...
  return (
    <>
      <section className="w-full min-h-screen p-[4vw]">
        <div className="hidden w-full h-full gap-8 md:flex md:justify-center">
          {/* The 3 images */}
          ...
          <div className="flex flex-col self-center w-[33%] gap-3">
            <h1 className="text-5xl font-bold text-[#022581]">
              Production House
            </h1>
            <p className="text-justify text-md tracking-wider [word-spacing:8px] text-[#022581]">
