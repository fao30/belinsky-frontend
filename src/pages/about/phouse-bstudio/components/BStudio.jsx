      ...
      <section className="flex flex-wrap justify-around w-full h-full text-[#022581] group my-[8vh] md:my-[16vh]">
        ...
        <div className="px-8 flex w-[100%] md:w-[90%] lg:-[70%] xl:w-[50%] h-full items-center gap-5">
          <div className="flex flex-col w-[50%] items-end gap-5">
            <CardHeroBS
              src={bh1}
              className="max-sm:group-hover:-translate-y-0 self-start object-cover transition duration-700 ease-in-out translate-x-16 translate-y-24 rounded-2xl grayscale hover:grayscale-0 max-xl:translate-y-48 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:delay-300 group-hover:duration-700 group-hover:ease-in-out"
          ...
          <div className="w-[50%]">
            <CardHeroBS
              src={bh2}
              className="object-cover max-sm:group-hover-translate-y-0 max-sm:translate-y-12 transition duration-700 ease-in-out -translate-x-20 -translate-y-28 rounded-2xl grayscale hover:grayscale-0 group-hover:translate-x-0 max-xl:translate-y-12 group-hover:translate-y-0 group-hover:delay-200 group-hover:duration-700 group-hover:ease-in-out"
