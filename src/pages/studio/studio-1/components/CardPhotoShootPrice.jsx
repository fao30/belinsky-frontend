const CardPhotoShootPrice = ({ p, h1, li }) => {
  return (
    <>
      <div className="border border-[#022581] w-[20rem] h-[12rem] md:w-[20rem] md:h-[15rem] lg:w-[25rem] lg:h-[16rem] text-center bg-white rounded-md drop-shadow-[0_1px_1px_black] mt-5 md:mt-10">
