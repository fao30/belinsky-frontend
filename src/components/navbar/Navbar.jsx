...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full flex justify-between px-[3vw] md:px-[5vw] lg:px-[6vw] md:py-[1vh] items-center bg-opacity-80 backdrop-blur bg-white text-[#022581] shadow-lg shadow-black/30">
