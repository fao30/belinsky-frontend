    ...
    <>
      <div className="flex flex-wrap-reverse justify-around w-full h-full text-[#022581] group my-[8vh] md:my-[16vh]">
        <div className="px-8 flex  w-[100%] md:w-[80%] lg:-[70%] xl:w-[50%] h-full items-center gap-5">
          <div className="flex flex-col w-[50%] items-start gap-5">
            <CardHeroPH
              src={ph1}
            ...
            <CardHeroPH
              src={ph2}
              className="w-[80%] object-cover transition duration-700 ease-in-out rounded-2xl grayscale hover:grayscale-0 translate-x-16 -translate-y-20 z-20 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:duration-700 group-hover:ease-in-out group-hover:delay-75"
